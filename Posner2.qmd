...
MLB_wins_ATT2023 %>% 
  ...
  labs(x = "Estimate Fewer Wins in 2023 if All Games Untreated", y = "Team (Abv)", title = "Team Estimated Wins if All Games Untreated", fill = "Conf. Interval Crosses 0")+
